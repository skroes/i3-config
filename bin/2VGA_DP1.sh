...
#1280x1024
#xrandr --output LVDS-1 --mode 1600x900 --pos 0x0 --rotate normal --output DP-3 --off --output DP-2 --off --output DP-1 --off --output VGA-1 --mode 1280x1024 --pos 1600x0 --rotate normal
...
# 1280x800
#xrandr --output LVDS-1 --mode 1600x900 --pos 0x0 --rotate normal --output DP-3 --off --output DP-2 --off --output DP-1 --off --output VGA-1 --mode 1280x800 --pos 1600x0 --rotate normal
